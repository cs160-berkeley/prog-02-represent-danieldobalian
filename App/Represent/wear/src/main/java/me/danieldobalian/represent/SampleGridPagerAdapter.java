 ...
 */
public class SampleGridPagerAdapter extends FragmentGridPagerAdapter implements View.OnClickListener {

    public final Context myContext;
    public static String data;
    public static Page[] names;

    public SampleGridPagerAdapter(Context ctx, FragmentManager fm, String data) {
        super(fm);
        myContext = ctx;
        this.data = data;
